...
- Naming: test*\*.py; functions and async tests named test*\*.
...
- Example skeleton:
  ...
  def test_defaults(self): # Arrange
  data = {"format": "markdown"} # Act # call your loader/validator # Assert
...
- To verify test execution in this repository, a temporary unittest was created, executed, and then removed (as requested):
  ...
  - Ran: python3 -m unittest discover -s tests -p "test\_\*.py"
  - Output:
